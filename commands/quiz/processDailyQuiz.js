module.exports ={
    ...
    async execute(bot, message, args){
        if (message == null){
            ...
            if ((!message.member.permissions.has(require('discord.js').PermissionFlagsBits.Administrator)) && (message.author.id != '169525036305219585') && (thisGuild.dailyQuizManager != message.author.id)){
